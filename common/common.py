...
EXTRACT_SERVICE_LOCALE_DIR = env.get('EXTRACT_SERVICE_LOCALE_DIR', '../resources/locale')
...
if EXTRACT_SERVICE_LANGUAGE:
    language = gettext.translation('extractor',
...
if service_conf is not None:
    ...
    CELERY_RESULT_BACKEND = service_conf.get('celery_result_backend', CELERY_RESULT_BACKEND)
