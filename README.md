...
Certains test on besoin d'avoir un accès à un base de données"autotest" avec l'extension Postgis, sur la machine en local. L'utilisateur courant doit pouvoir s'y connecter sans mot de passe
